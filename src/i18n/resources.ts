...
const resources = {
  ...
  'result.collapse': 'Hide details',
  'result.expand': 'Show details',
  ...
  'summary.documents-scanned': 'Documents scanned',
  'summary.issue-count_one': '{{count}} issue found',
  'summary.issue-count_other': '{{count}} issues found',
  'summary.last-scan': 'Last scan',
  'summary.link-instances': 'Link instances',
  'summary.no-issues': 'No issues found',
  'summary.scanned-via': 'Scanned via',
  'summary.source.browser': 'Browser scan',
  'summary.source.cli': 'CLI',
  'summary.source.function': 'Sanity Function',
  'summary.unique-urls': 'Unique URLs',
  'tabs.active': 'Active',
  'tabs.broken': 'Broken',
  'tabs.ok': 'OK',
